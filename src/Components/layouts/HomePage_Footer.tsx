    ...
    return (
        ...
        >
            <Divider style={{ color: '#bfbfbf', fontWeight: '200', fontSize: '0.6vw' }}>
                ...
                <a href="https//github.com/LeonardoSya" style={{ margin: "0.5vw", color: '#bfbfbf', fontWeight: '200' }}>Security</a>
                <a href="https//github.com/LeonardoSya" style={{ margin: "0.5vw", color: '#bfbfbf', fontWeight: '200' }}>Privacy</a>
                <a href="https//github.com/LeonardoSya" style={{ margin: "0.5vw", color: '#bfbfbf', fontWeight: '200' }}>Docs</a>
                <a href="https://github.com/LeonardoSya" style={{ margin: "0.5vw", color: '#bfbfbf', fontWeight: '200' }}>Contact</a>
                <a href="https//github.com/LeonardoSya" style={{ margin: "0.5vw", color: '#bfbfbf', fontWeight: '200' }}>Cookies</a>
            </Divider>
        </Footer>
    );
}

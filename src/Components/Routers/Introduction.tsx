...
"               textCN="🌍 革命性的生态地图：Ecolens在生态监测领域堪称创新典范，我们提供先进的地图服务，提出地理数据可视化的优秀解决方案，以保护我们的环境瑰宝"
            ...
            <CardImage
                ...
                textCN="🌱 环保卫士，精准防护：Ecolens不仅提供地图，更是一项堪称'环保卫士'的精准防护工具。其细致入微的细节和实时监测功能赋予用户明智决策的力量，开创了生态意识的新时代"
            />
            <CardImage
                src="https://react.docschina.org/images/home/community/react_india_sunil.webp"
                textEN="♻️ Seamless Integration, Maximum Impact: Ecolens seamlessly integrates into the modern world, making ecological awareness accessible to all. Its user-friendly interface and powerful features ensure that monitoring and preserving our ecosystems become second nature."
                textCN="♻️无缝集成，影响深远：Ecolens无缝融入现代社会，使生态数据可视化唾手可得。其用户友好的界面和强大功能有力地支持了生态监测和保护工作"
            />
            <CardImage

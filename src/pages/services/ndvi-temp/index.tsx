    ...
    return (
        <Flex gap="middle" vertical style={{ background: " linear-gradient(0deg, #000000cc 0%, #4b5876 60%, #f5f5f5 90%)" }}>
            <Row justify="center" align="middle">
                <Col span={4}><strong style={{ fontSize: '1vw', color: '#389e0d' }}>NDVI </strong><Typography.Text style={{ fontSize: '1vw' }}>季度变化筛选</Typography.Text></Col>
                <Col span={4}><MapSelector onSelect={handleNDVISelect} startDate='2018-03-01' endDate='2023-03-01' /></Col>
                <Col span={3}></Col>
                <Col span={4}><strong style={{ fontSize: '1vw', color: '#d4380d' }}>气温 </strong> <Typography.Text style={{ fontSize: '1vw' }}>季度变化筛选</Typography.Text></Col>

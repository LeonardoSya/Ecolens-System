    ...
    return (
        <Flex gap="middle" vertical style={{ background: " linear-gradient(0deg, #000000cc 0%, #4b5876 60%, #f5f5f5 90%)" }}>
            <Row justify="center" align="middle">
                <Col span={4} ><span style={{ fontSize: '1vw', color: '#389e0d' }}>NDVI </span> on a quarterly basis</Col>
                <Col span={4}><MapSelector onSelect={handleNDVISelect} startDate='2018-03-01' endDate='2023-03-01' /></Col>
                <Col span={3}></Col>
                <Col span={6} ><span style={{ fontSize: '1vw', color: '#d4380d' }}>TEMPERATURE </span> on a quarterly basis</Col>
